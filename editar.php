        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="numeroDocumento" id="numeroDocumento" 
                    class="form-control" value="<?php echo $cliente['numero_documento'] ?>">
            </div>

            <div class="mb-3">
                <label for="direccion" class="form-label">Dirección:</label>
                <input type="text" name="direccion" id="direccion" 
                    class="form-control" value="<?php echo $cliente['direccion'] ?>">
            </div>

            <div class="mb-3">
                <label for="referencia" class="form-label">Referencia:</label>
                <textarea name="referencia" id="referencia" rows="5" 
                    class="form-control"><?php echo $cliente['referencia'] ?></textarea>
            </div>
